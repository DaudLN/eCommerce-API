# Generated by Django 4.1.4 on 2023-04-26 21:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('B', 'Blonze'), ('S', 'Silver'), ('G', 'Gold')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discout', models.DecimalField(decimal_places=2, max_digits=6)),
            ],
            options={
                'verbose_name': 'Promossion',
                'verbose_name_plural': 'Promossions',
            },
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('promossions', models.ManyToManyField(to='store.promossion', verbose_name='Promossion')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
